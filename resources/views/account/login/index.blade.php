                ...
                <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white  ">
                    ...
                    <form class="mt-8 space-y-6" id="recaptcha-form" action="{{ route('login.authenticate') }}" method="post">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 " placeholder="Enter your email" required value="{{ old('password') }}">
                        </div>
                        <div>
